  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'item',
        name: 'PlanItem',
        component: () => import('../views/front/PlanItem.vue')
      },
      {
        path: 'dashBoard',
        name: 'DashBoard',
      ...
      },
      {
        path: 'consumption',
        name: 'Consumption',
        component: () => import('../views/front/Consumption.vue')
      },
      {
        path: 'consumDashboard',
        name: 'ConsumDashboard',
        component: () => import('../views/front/ConsumDashboard.vue')
      },
      {
        path: 'category',
        name: 'Category',
