...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="duration" label="周期"></el-table-column>
      <el-table-column prop="total" label="总金额"></el-table-column>
      <el-table-column prop="money" label="每日存入金额"></el-table-column>
      <el-table-column prop="moneyIn" label="已存入金额"></el-table-column>
      <el-table-column prop="remain" label="剩余金额"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="100px" size="small" style="width: 90%">
        ...
        <el-form-item label="每日存入金额">
          <el-input v-model="form.money" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="已存入金额">
          <el-input v-model="form.moneyIn" autocomplete="off"></el-input>
        </el-form-item>
