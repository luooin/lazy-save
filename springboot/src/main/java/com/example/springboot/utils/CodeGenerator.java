...
public class CodeGenerator {
    private static final String DATASOURCE = "person-account";
    private static final String basePath = "D:\\毕设\\作品\\2022.5\\个人记账\\springboot\\";

    private static final String tableName = "plan";
    private static final String modelName = "存钱计划管理";
